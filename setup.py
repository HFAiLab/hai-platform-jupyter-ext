"""
jupyterlab_hai_platform_ext setup
"""
import json
import os
...
setup_args = dict(
    ...
    description="A JupyterLab extension to use HAI Platform service",
